...
Example: abs(x)");
        ...
        private void CreateSettingsMenu()
        {
            ...
            titleLabel.Location = new Point(
                (settingsPanel.Width - titleLabel.Width) / 2 - 33,
                30
            );
            ...
            musicLabel.Location = new Point(
                (settingsPanel.Width - musicLabel.Width) / 2 - 33,
                100
            );
        ...
        private void CreateThemesMenu()
        {
            ...
            titleLabel.AutoSize = true;
            titleLabel.Location = new Point(
                (themesPanel.Width - titleLabel.Width) / 2,
                30
            );
        ...
        private void CreateStatsMenu()
        {
            ...
            titleLabel.AutoSize = true;
            titleLabel.Location = new Point(
                (statsPanel.Width - titleLabel.Width) / 2,
                30
            );
